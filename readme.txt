Ứng dụng quản lý đoàn viên

1. Yêu cầu 
- Sử dụng IDE hoặc TextEditor phù hợp: IntelliJ hoặc Visual Studio Code.
- Sử dụng hệ cơ sở dữ liệu mySQL XAMPP: https://www.apachefriends.org/download.html
...
3. Công nghệ sử dụng
- Hệ CSDL MySQL
- Ngôn ngữ lập trình Java kèm theo thư viện Java Spring Boot
- Thiết kế và xử lý giao diện web sử dụng html, css, bootstrap, javascript